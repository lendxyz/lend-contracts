...
/// @custom:oz-upgrades-from src/legacy/Restitution/RestitutionV1.sol:LendRestitutionV1
contract LendRestitution is Initializable, OwnableUpgradeable, UUPSUpgradeable {
    IERC20 public usdc;
