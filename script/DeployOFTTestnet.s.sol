...
contract DeployOFTTestnet is Script {
    ...
    string name = "Lend Operation - Apartment Kensington";
    string symbol = "opLEND-9";
    ...
    function run() public {
        ...
        bytes32 peer = bytes32(uint256(uint160(address(0x5818295773901eF40a3b0c624a3FC50E52856319))));
